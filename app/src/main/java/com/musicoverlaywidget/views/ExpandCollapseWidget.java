...
public class ExpandCollapseWidget extends ImageView implements PlaybackState.PlaybackStateListener {
	...
	public ExpandCollapseWidget(@NonNull Configuration configuration) {
		...
		this.padding = configuration.context().getResources().getDimensionPixelSize(R.dimen.widget_expand_collapse_widget_padding);
	...
	public ExpandCollapseWidget onWidgetStateChangedListener(OnWidgetStateChangedListener onWidgetStateChangedListener) {
	...
	public void onControlsClickListener(OnControlsClickListener onControlsClickListener) {
    ...
    public BoundsCheckerImpl newBoundsChecker(int offsetX, int offsetY) {
    ...
    private static final class BoundsCheckerImpl extends BoundsCheckerWithOffset {
